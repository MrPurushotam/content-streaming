...
const UploadContent = () => {
  ...
  const uniqueIdRef:string = useRef();
  const contentIdRef:number = useRef();
  ...
  return (
    <div className="w-full h-screen flex flex-col items-center p-8 bg-gray-50">
      ...
      <h2 className="text-3xl font-bold text-gray-800 mb-6">Upload Content</h2>
      ...
      <div className="w-1/2 border-2 border-cyan-600 shadow-md shadow-cyan-500 rounded-md my-7 p-2 flex flex-row gap-4 items-center">
        <div className="aspect-video w-60 h-40 rounded-md border-2 border-red-500 bg-gray-200 flex justify-center items-center">
          {preview ? (
