    ...
    return (
        <>
            <Seo
                ...
                type="website"
                address={`/upload/edit/${params?.id}`}
            />

            <div className="w-full min-h-screen flex flex-col gap-2 items-center p-4 sm:p-8 bg-gray-50">

                <div className="w-full md:w-4/5 xl:w-2/3 border-2 border-cyan-600 shadow-md shadow-cyan-500 rounded-md my-5 p-2 flex flex-col items-center">
                    <div className="aspect-video w-full rounded-md shadow-md shaodw-yellow-500 bg-gray-200 flex justify-center items-center">
                        {manifest ? (
                            <HLSPlayer
                                src={manifest}
                ...
                <div className="w-full md:w-4/5 xl:w-2/3 border-2 border-cyan-600 shadow-md shadow-cyan-500 rounded-md p-2 flex flex-col lg:flex-row gap-4 items-center">
                    <div className="aspect-video w-full xl:w-1/2 h-52 xl:h-64 rounded-md shadow-sm shadow-red-500 bg-gray-200 flex justify-center items-center">
                        {preview ? (
                            <img src={preview} alt="Thumbnail" className="w-full h-full object-contain rounded-md" />
                        ) : (
                            <span className="text-gray-500">No Thumbnail</span>
                        )}
                    </div>
                    <div className="w-full xl:w-1/2 h-full rounded-md flex flex-col px-3 py-2 gap-2">
                ...
                <div className="w-full max-w-3xl p-6 bg-white rounded-lg shadow-lg flex flex-col lg:flex-row gap-8 items-start border border-gray-200 my-5">
                    {/* Thumbnail Upload */}
                    <div className="flex flex-col items-center gap-4 w-full lg:w-1/2">
                        ...
                        {thumbnail && preview ? (
                            ...
                            <label className="w-40 h-40 flex items-center justify-center bg-gray-100 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-200 transition">
                                ...
                                <span className="text-gray-500">Update Thumbnail</span>
                            </label>
                        )}
                    </div>

                    <div className="flex flex-col gap-5 flex-1 w-full lg:w-1/2">
                        {/* Public Toggle */}
