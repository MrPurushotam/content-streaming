...
const VideoCard: React.FC<VideoCardTypes> = ({ id, title = "dfds", views = 535, thumbnail ="", video }) => {
    ...
    return (
        <div className={`w-full sm:w-[100%] md:w-[48%] lg:w-[32%] xl:w-[32%] h-76 p-2 rounded-md shadow-md flex flex-col gap-1 transition-shadow duration-300 ${isHovered ? 'shadow-[0_0_15px_rgba(59,130,246,0.5)]' : ''}`}
